...
% MW: Where the workers store job output accessible to the MirrorHost
...
% MW: The job directory as accessed by workers on the cluster, accessible from the MirrorHost
if cluster.HasSharedFilesystem
...
if ~cluster.HasSharedFilesystem
    % Store the remote job storage location and mirror host
